...
const Hero = () => {
  return (
    <div className="h-screen w-full mt-16 flex flex-col justify-center items-center bg-gradient-to-r from-pink-100 via-white to-blue-100 text-gray-800 shadow-lg shadow-pink-200/50">

...
const Hero = () => {
  return (
    <div className="h-screen mt-16 flex flex-col justify-center items-center bg-gradient-to-r from-pink-100 via-white to-blue-100 text-gray-800 shadow-lg shadow-pink-200/50">
      <div className="h-screen text-center space-y-6 backdrop-blur-lg bg-white/30 p-10 rounded-lg max-w-4xl mx-auto">
        <h1 className="text-5xl font-extrabold tracking-tight leading-tight relative inline-block">
          Welcome to{" "}
        ...
        <h3 className="text-lg md:text-xl lg:text-2xl font-medium max-w-lg mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-4">
          <div className="bg-white/70 p-4 rounded-lg shadow-md w-60">
            <h4 className="font-semibold text-xl text-blue-600">Quick Job Placement</h4>
            <p className="text-sm text-gray-600">
              Our programs are tailored to get you job-ready in record time.
            </p>
          </div>
          <div className="bg-white/70 p-4 rounded-lg shadow-md w-60">
            <h4 className="font-semibold text-xl text-blue-600">Lowest Fees</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="bg-white/70 p-4 rounded-lg shadow-md w-60">
            <h4 className="font-semibold text-xl text-blue-600">Comprehensive Courses</h4>
            <p className="text-sm text-gray-600">

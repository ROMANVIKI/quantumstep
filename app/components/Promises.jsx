      ...
      <div className="space-y-8">
        ...
        <div className="bg-white/70 p-6 rounded-lg shadow-md">
          ...
          <p className="text-sm md:text-base text-gray-600 mt-2">
            ...
            100% practical training, ensuring you gain complete mastery of your
            chosen field. Our expert mentors consistently provide hands-on
            experience with real-time projects, equipping you with the practical
        ...
        <div className="bg-white/70 p-6 rounded-lg shadow-md">
          ...
          <p className="text-sm md:text-base text-gray-600 mt-2">
            ...
            placement immediately after completion. With hands-on experience in
            real-world project scenarios, our practical training prepares you to
            confidently tackle projects in your career.
          </p>
        </div>
      </div>
    </div>
